...
STRINGS = {
    ...
    # ── Arabic ────────────────────────────────────────────────────────────────
    "ar": {
        "tagline":          "شغّل الذكاء الاصطناعي على أي جهاز. بدون حاسوب. بدون اشتراك.",
        "free_forever":     "مجاني للأبد · GPL v3",
        "loading":          "جارٍ تحميل llamdrop...",
        "menu_chat":        "ابدأ المحادثة",
        "menu_browse":      "تصفح وتنزيل",
        "menu_mymodels":    "نماذجي المحملة",
        "menu_resume":      "استئناف جلسة محفوظة",
        "menu_search":      "البحث في HuggingFace",
        "menu_device":      "معلومات الجهاز",
        "menu_help":        "المساعدة",
        "menu_quit":        "خروج",
        "desc_chat":        "اختر نموذجاً محملاً وابدأ",
        "desc_browse":      "ابحث عن نماذج تناسب جهازك",
        "desc_mymodels":    "شاهد ما لديك مثبتاً",
        "desc_resume":      "تابع محادثة سابقة",
        "desc_search":      "ابحث في جميع نماذج GGUF على HuggingFace",
        "desc_device":      "اعرض مواصفات جهازك",
        "desc_help":        "كيفية استخدام llamdrop",
        "no_models":        "لم يتم تنزيل أي نماذج بعد.",
        "go_to_browse":     "انتقل إلى 'تصفح وتنزيل' للحصول على نموذجك الأول.",
        "already_dl":       "تم التنزيل مسبقاً. انتقل إلى 'ابدأ المحادثة' لاستخدامه.",
        "dl_failed":        "فشل التنزيل",
        "dl_ready":         "جاهز! انتقل إلى 'ابدأ المحادثة' لاستخدامه.",
        "no_sessions":      "لم يتم العثور على جلسات محفوظة.",
        "press_enter_back": "اضغط Enter للعودة...",
        "save_session":     "حفظ هذه المحادثة؟ (y/N): ",
        "session_saved":    "تم الحفظ",
        "goodbye":          "مع السلامة!",
        "chat_header":      "محادثة",
        "chat_help_hint":   "اكتب /help للأوامر · Ctrl+C أو /quit للخروج",
        "cmd_save":         "/save   — حفظ المحادثة",
        "cmd_clear":        "/clear  — مسح سجل المحادثة",
        "cmd_ram":          "/ram    — عرض استخدام الذاكرة",
        "cmd_quit":         "/quit   — الخروج من المحادثة",
        "context_trimmed":  "تم تقليص السياق لتحرير الذاكرة",
        "ram_critical":     "الذاكرة حرجة — أغلق التطبيقات الأخرى!",
        "ram_low":          "الذاكرة منخفضة — كن حذراً",
        "ram_ok":           "الذاكرة جيدة",
        "search_prompt":    "البحث في HuggingFace (مثال: 'llama chat' أو 'qwen عربي'): ",
        "searching":        "جارٍ البحث في HuggingFace...",
        "search_none":      "لم يتم العثور على نماذج متوافقة. جرب بحثاً مختلفاً.",
        "unverified_warn":  "⚠ هذه النتائج غير موثقة — تقديرات الذاكرة فقط.",
        "update_catalog":   "تم تحديث قائمة النماذج إلى",
        "update_app":       "إصدار جديد من llamdrop متاح",
        "llama_missing":    "لم يتم العثور على llama.cpp. قم بتشغيل المثبت أولاً.",
        "nav_hint":         "↑↓ تنقل   Enter اختيار   Q خروج",
    },
}
